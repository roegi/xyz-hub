...
public class AbstractConnectorHandlerTest {
  ...
  private static String testEvent = "{"
      + "  \"type\": \"RelocatedEvent\","
      + "  \"location\": \"6r9a1s051z\","
      + "  \"URI\": \"s3://xyz-hub-sit-s3bucket-1y59epmy6s00/tmp/6r9a1s051z\"\n"
      + "}";
...
////    RelocatedEvent relocated = new RelocatedEvent().withLocation("6r9a1s051z")
////        .withURI("s3://xyz-hub-sit-s3bucket-1y59epmy6s00/tmp/6r9a1s051z");
//
//    RelocatedEvent relocated = XyzSerializable.deserialize(testEvent);
//    System.out.println(relocated.serialize());
//
//    InputStream input = client.processRelocatedEvent(relocated);
//    String relocatedText = new BufferedReader(new InputStreamReader(input)).lines().collect(Collectors.joining("\n"));
//    System.out.println(relocatedText);
//  }
  ...
  public void readEvent() {
    InputStream is = new ByteArrayInputStream(HealthCheckEventString.getBytes(StandardCharsets.UTF_8));
